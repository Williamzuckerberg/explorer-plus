...
TOOLBAR_SEARCH,TOOLBAR_PROPERTIES,TOOLBAR_REFRESH, TOOLBAR_SORT};
...
private:
    ...
    void                    OnToolbarSort(void); //bird
    void                    ShowToolbarSortDropdown(void); //bird
    ...
    void					CreateSortMenu(POINT *ptOrigin); //BIRD
